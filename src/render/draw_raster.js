...
function drawRaster(painter: Painter, sourceCache: SourceCache, layer: RasterStyleLayer, coords: Array<OverscaledTileID>) {
    ...
    for (const coord of coords) {
        ...
        const depthMode = painter.depthModeFor3D(coord.overscaledZ - minTileZ,
        ...
        const uniformValues = rasterUniformValues(posMatrix, parentTL || [0, 0], parentScaleBy || 1, fade, layer, groundRatio);
